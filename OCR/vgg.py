...
data_dir = '/content/LP_recognition/Glyphs'
...
data_transforms = {
    'train': transforms.Compose([
        ...
        transforms.RandomApply([
            transforms.ColorJitter(2, 2, 2, 0.5),
            transforms.RandomAffine(5, (0.1, 0.1), (0.9, 1.1)),
        ]),
        transforms.ToTensor(),
    ]),
...
torch.save(model_ft.state_dict(), "./resnet_100epochs_50pxls.pt")
